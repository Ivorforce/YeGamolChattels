...
public class GridQuadCache<T> implements Iterable<GridQuadCache.CachedQuadLevel<T>>
{
    ...
    public static <T> GridQuadCache<T> createQuadCache(int[] size, Function<Pair<BlockPos, EnumFacing>, T> mapper)
    {
        return createQuadCacheGreedy(size, mapper);
    }

    protected static <T> GridQuadCache<T> createQuadCacheGreedy(int[] size, Function<Pair<BlockPos, EnumFacing>, T> mapper)
    {
