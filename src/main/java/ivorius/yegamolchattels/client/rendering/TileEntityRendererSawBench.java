...
public class TileEntityRendererSawBench extends TileEntitySpecialRenderer
{
    ...
    public TileEntityRendererSawBench()
    {
    ...
    {
        renderTileEntityPlankSawAt((TileEntitySawBench) tileentity, d, d1, d2, f);
    }

    public void renderTileEntityPlankSawAt(TileEntitySawBench tileEntity, double d, double d1, double d2, float f)
    {
